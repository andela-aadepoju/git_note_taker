	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'button',
	            { type: 'submit', className: 'btn btn-block btn-info' },
	            'Search Github'
	          )
	        )
	      )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Profile = React.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    this.ref = new Firebase('https://adeynotetaker.firebaseio.com');
	    this.init();
	  },
	  componentWillReceiveProps: function componentWillReceiveProps() {
	    this.unbind('notes');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var NoteList = __webpack_require__(209);
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'button',
	          { className: 'btn btn-info', type: 'button', onClick: this.handleSubmit },
	          'Submit'
	        )
	      )
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var btoa = (typeof window !== 'undefined' && window.btoa) || __webpack_require__(226);
